...
class test_git_api(unittest.TestCase):
    ...
    def test_sample(self): 
        self.assertEqual(githubapi.getRepos('richkempinski'), {'csp': 2, 'threads-of-life': 1, 'helloworld': 6, 'try_nbdev2': 5, 'Mocks': 10, 'try_nbdev': 2, 'hellogitworld': 30, 'Project1': 2, 'richkempinski.github.io': 9})
